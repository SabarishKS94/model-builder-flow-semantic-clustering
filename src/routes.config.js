...
export const routes = [
  ...
  { path: '/aim-cluster/builder-v2', component: 'page-cluster-builder-v2', title: 'Cluster Builder V2', fullscreen: true },
  { path: '/aim-cluster/builder-v3', component: 'page-cluster-builder-v3', title: 'Cluster Builder V3', fullscreen: true },
  { path: '/aim-cluster/builder-v4', component: 'page-cluster-builder-v4', title: 'Cluster Builder V4', fullscreen: true },
